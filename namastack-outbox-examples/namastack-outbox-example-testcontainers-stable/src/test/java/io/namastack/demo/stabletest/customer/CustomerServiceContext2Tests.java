...
@ActiveProfiles({"context2"})
@SpringBootTest
@TestInstance(TestInstance.Lifecycle.PER_CLASS)
class CustomerServiceContext2Tests implements TestsWithKafka, TestWithPostgres {
  ...
  @Test
  void registerCustomerAndVerifyKafkaEvent2() {
    ...
    await()
        ...
        .untilAsserted(
            () -> {
              ...
              assertThat(event.getFirstname()).isEqualTo("Thomas");
              assertThat(event.getLastname()).isEqualTo("Edison");
              assertThat(event.getEmail()).isEqualTo("thomas.edison@example.com");
            });
  }
}
